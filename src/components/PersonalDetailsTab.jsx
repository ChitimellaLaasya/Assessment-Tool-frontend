    ...
    {classOptions.map((option) => (
      ...
      <div className="flex flex-col">
        ...
        {watch("informant") === "other" && (
          <input
            type="text"
            placeholder="Please specify informant (e.g., Warden)"
            className="block w-full px-4 py-3 mt-3 text-base text-gray-900 border rounded-lg transition-all duration-200"
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          <option value="school-1">St. Xavier's High School</option>
          <option value="school-2">Greenwood Public School</option>
          <option value="school-3">The International School</option>
          {/* REQUIREMENT: Include an "Other" option */}
          <option value="other">Other</option>
        </select>

        {/* REQUIREMENT: If "Other" is selected, show blank field to enter school name */}
        {watch("school") === "other" && (
          <input
            type="text"
            placeholder="Enter specific school name"
            className="block w-full px-4 py-3 mt-3 text-base text-gray-900 border rounded-lg transition-all duration-200 animate-in fade-in"
            style={{
              borderColor: errors.otherSchool ? 'red' : 'var(--medium-gray)',
            }}
